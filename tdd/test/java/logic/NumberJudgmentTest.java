...
public class NumberJudgmentTest {
    ...
    public void testShouldThrowExceptionWhenHaveRepeatNumberWhenCompare5555And1234() throws Exception {
        try {
            new NumberJudgment().compare("5555", "1234");
            fail();
        } catch (RuntimeException e) {
